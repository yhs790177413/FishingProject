...
public class BarEntry extends Entry {
	 ...
	 * @param xIndex
	 */
	public BarEntry(int[] vals, int xIndex) {
	 ...
	 * @param xIndex
	 */
	public BarEntry(int val, int xIndex) {
		super(val, xIndex);
	}
	 ...
	 */
	public BarEntry(int[] vals, int xIndex, String label) {
	 ...
	 */
	public BarEntry(int val, int xIndex, Object data) {
	...
	/**
	 * Returns the value of this BarEntry. If the entry is stacked, it returns
	 * the positive sum of all values.
	 * 
	 * @return
	 */
	@Override
	...
	/**
	 * Returns true if this BarEntry is stacked (has a values array), false if
	 * not.
	 * 
	 * @return
	 */
	 ...
	 * @return
	 */
	private static int calcSum(int[] vals) {
