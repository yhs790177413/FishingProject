...
public class Util {
	...
	public static ArrayList<String> getSeletedImages(Context context) {
		...
		String images = ConfigUtil.getInstance(context).get(
				ConfigUtil.C_SELECTED_IMAGES);
	 ...
	 * @param imgList
	 */
	public static void saveSelectedImags(Context context,
		...
		ConfigUtil.getInstance(context).save(ConfigUtil.C_SELECTED_IMAGES,
				result.toString());
	}
