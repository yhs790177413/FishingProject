...
public class MyAttentionActivity extends AbsBaseActivity implements
		OnClickListener {
	...
	private void initFragments() {
		...
		fNames.add(MyAttentionFragment.class.getName());
		fNames.add(MyFansFragment.class.getName());
