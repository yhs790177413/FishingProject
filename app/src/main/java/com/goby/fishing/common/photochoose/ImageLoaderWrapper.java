...
//				cacheDir));
		imageLoaderConfigurationBuilder.diskCacheSize(100 * 1024 * 1024);
		imageLoaderConfigurationBuilder
				.diskCacheFileNameGenerator(new HashCodeFileNameGenerator());
		imageLoaderConfigurationBuilder.diskCacheFileCount(100);
		...
		imageLoaderConfigurationBuilder.diskCacheFileNameGenerator(new HashCodeFileNameGenerator()); // default
        imageLoaderConfigurationBuilder.defaultDisplayImageOptions(DisplayImageOptions.createSimple()); // default
		if (debug) {
...
//					"Must be call initDefault(Context, File) befor!");
	 ...
	 */
	public void displayImage(String imageUri, ImageView imageView,DisplayConfig config,int resDefault) {
		config.loadFailImageRes=resDefault;
		config.stubImageRes=resDefault;
		displayImage(imageUri, imageView, config, null);
		config.loadFailImageRes=0;
		config.stubImageRes=0;
	}
...
//                .showImageForEmptyUri(config.stubImageRes).showImageOnFail(config.stubImageRes).cacheInMemory(true)  
...
//	}
	...
	public static class DisplayConfig {
		...
		public int stubImageRes=R.drawable.loadding_icon;
		public int loadFailImageRes=R.drawable.loadding_icon;
		private BitmapDisplayer displayer;
		private final ImageScaleType imageScaleType = ImageScaleType.IN_SAMPLE_INT;
		...
		private DisplayConfig() {
			...
			isResetView = false;
			stubImageRes = R.drawable.loadding_icon;
			loadFailImageRes = R.drawable.loadding_icon;
