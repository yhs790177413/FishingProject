...
public class EmojiIndicatorView extends LinearLayout {
	...
	public EmojiIndicatorView(Context context, AttributeSet attrs) {
		...
		bmpSelect = BitmapFactory.decodeResource(getResources(),
				R.drawable.indicator_point_select);
		bmpNomal = BitmapFactory.decodeResource(getResources(),
				R.drawable.indicator_point_nomal);
	}
	...
	public void init(int count) {
		...
		for (int i = 0; i < count; i++) {
			...
			LayoutParams params = new LinearLayout.LayoutParams(mMaxHeight,
					mMaxHeight);
	...
	public void playBy(int startPosition, int nextPosition) {
		...
		ObjectAnimator anim1 = ObjectAnimator.ofFloat(imageViewStrat, "scaleX",
				1.0f, 0.25f);
		ObjectAnimator anim2 = ObjectAnimator.ofFloat(imageViewStrat, "scaleY",
				1.0f, 0.25f);
		...
		anim1.addListener(new Animator.AnimatorListener() {
			...
			public void onAnimationEnd(Animator animation) {
				...
				ObjectAnimator animFil1l = ObjectAnimator.ofFloat(
						imageViewStrat, "scaleX", 1.0f);
				ObjectAnimator animFill2 = ObjectAnimator.ofFloat(
						imageViewStrat, "scaleY", 1.0f);
