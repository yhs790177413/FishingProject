...
public class WheelView extends ViewGroup implements OnGestureListener {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(mContext.getResources().getColor(R.color.blue_35b2e1));
		...
		if (null != drawText) {
			...
			canvas.drawText(drawText, getWidth() - 20, baseline, paint);
	...
	private void setSelectionItemText(int selection) {
		...
		for (int i = 0; i < getChildCount(); i++) {
			TextView tv = (TextView) getChildAt(i).findViewById(R.id.tv_item);
			if (i == selection) {
