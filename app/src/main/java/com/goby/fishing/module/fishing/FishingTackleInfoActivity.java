...
public class FishingTackleInfoActivity extends AbsBaseActivity implements
		OnClickListener {
	...
	public static void launch(Activity activity, int requestCode) {
		...
		Intent intent = new Intent(activity, FishingTackleInfoActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fishing_tackle_info);
	...
	public void onClick(View view) {
		...
		case R.id.submit_title:
			if (!TextUtils.isEmpty(et_content.getText().toString().trim())) {
				...
				intent.putExtra("fishingTackleInfo", et_content.getText()
						.toString().trim());
