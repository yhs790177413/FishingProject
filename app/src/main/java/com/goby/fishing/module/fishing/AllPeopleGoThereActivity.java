...
public class AllPeopleGoThereActivity extends AbsBaseActivity implements
	...
	public static void launch(Activity activity, ArrayList<Like> dataList) {
		...
		Intent intent = new Intent(activity, AllPeopleGoThereActivity.class);
		...
		public View getView(final int position, View convertView, ViewGroup arg2) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater
						.from(AllPeopleGoThereActivity.this).inflate(
			...
			viewholder.icv_userHeader.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if (dataList.get(position).user_id
						...
						MainActivity.launch(AllPeopleGoThereActivity.this,
								"meFragment");
					} else {
						OtherInfoActivity.launch(AllPeopleGoThereActivity.this,
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		if (dataList.get(position).user_id.equals(sharedPreferenceUtil
				.getUserID())) {
			MainActivity.launch(AllPeopleGoThereActivity.this, "meFragment");
		} else {
			OtherInfoActivity.launch(AllPeopleGoThereActivity.this,
					dataList.get(position).user_id);
		}
